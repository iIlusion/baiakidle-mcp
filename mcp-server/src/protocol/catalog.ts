...
export function lookupMessage(name: string | null | undefined): MessageMeta {
  if (!name) return { name: "?", direction: "both", category: "unknown", spam: false };
  return (
